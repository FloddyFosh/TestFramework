...
public class SeleniumHelper {
    ...
    public static void acceptAlert() {
        try {
            ...
            System.out.printf("Didn't see an alert to accept within %d seconds, moving on...%n",
                    Globals.DEFAULT_UI_TIMEOUT);
        }
    }
    ...
    public static void waitForElementToBeClickable(By by, int timeout) {
        try {
            ...
            Assert.fail(String.format(
                    "Error in waitForElementToBeVisible(): Element %s could not be found", by.toString()));
        }
    }
    ...
    public static void waitForElementToDisappear(By by) {
        ...
        try {
            ...
            Assert.fail(String.format(
                    "Error in waitForElementToAppear(): Element %s did not disappear", by.toString()));
        }
    }
    ...
    public static void waitForElementToContainText(By by, String partialElementText) {
        ...
        try {
            ...
            Assert.fail(String.format(
                    "Error in waitForElementToContainText(): Element %s did not contain text '%s'",
                    by.toString(), partialElementText));
        }
    }
    ...
    public static void waitForElementToNotContainPartialText(By by, String partialElementText) {
        ...
        try {
            ...
            Assert.fail(String.format(
                    "Error in waitForElementToNotContainText(): Element %s did contain text '%s'",
                    by.toString(), partialElementText));
        }
    }
